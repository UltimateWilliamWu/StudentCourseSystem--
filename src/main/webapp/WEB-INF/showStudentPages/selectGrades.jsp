                ...
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            ...
                            <li class="active"><a href="selectGrades" >成绩查询</a></li>
    ...
    <div class="container-wrap">
        <div id="fh5co-work" class="fh5co-light-grey">
            <div class="row animate-box">
                ...
                <hr>
                <p style="text-align: center">以下为当前学生的所有信息：</p>
                <form class="smart-green" style="text-align: center">
                    <table border="1" style="text-align: center;margin: 0 auto;">
                        <tr style="height: 80px;text-align: center">
                            ...
                            <%--<th style="height: 80px;text-align: center">平均成绩</th>--%>
                        </tr>
                        <c:forEach items="${grades}" var="Course">
                            <tr style="height: 80px">
                                <td>${Course.cname}</td>
                                <td>${Course.ggrades}</td>
                                <td>${Course.tgrades}</td>
                                <td>${Course.fgrades}</td>
                                <%--<td>${Course.avg}</td>--%>
                            </tr>
                        </c:forEach>
                    </table><br><br>
