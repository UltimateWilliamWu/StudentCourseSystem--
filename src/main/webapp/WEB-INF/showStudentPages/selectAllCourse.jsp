            ...
            <div class="top-menu">
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            <li class="active"><a href="selectAllCourse">所有课程</a></li>
    ...
    <div class="container-wrap">
        <div id="fh5co-work" class="fh5co-light-grey">
            <div class="row animate-box">
                ...
                <hr>
                <form action="selectStudentCourse" class="smart-green">
                    <table border="1" style="margin: 0 auto">
                        <tr style="height: 80px;text-align: center">
                            ...
                            <th style="height: 80px;text-align: center">选课</th>
                        </tr>
                        <c:forEach items="${courses}" var="Course">
                            <tr style="height: 80px">
                                ...
                                <td>${Course.cyear}</td>
                                <td><label><input type="checkbox" name="course" value="${Course.cid}">选课</label></td>
                            </tr>
                        </c:forEach>
                        <tr>
                            <td colspan="5" align="right" style="height: 80px">
                                &nbsp;&nbsp;共${totalCount}条记录&nbsp;&nbsp;共${totalPage}页&nbsp;&nbsp;
                                第${pageCur}页&nbsp;&nbsp;
                                <c:url var="url_pre" value="selectAllCourse">
                                    <c:param name="studentID" value="${sessionScope.studentID}"></c:param>
                                    <c:param name="pageCur" value="${pageCur-1}"></c:param>
                                </c:url>
                                <c:url var="url_next" value="selectAllCourse">
                                    <c:param name="studentID" value="${sessionScope.studentID}"></c:param>
                                    <c:param name="pageCur" value="${pageCur+1}"></c:param>
                                </c:url>
                                <c:if test="${pageCur!=1}">
