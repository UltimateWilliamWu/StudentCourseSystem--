    ...
    <div class="container-wrap">
        <div id="fh5co-work" class="fh5co-light-grey">
            <div class="row animate-box">
                ...
                <form action="classroomDel" method="post" class="smart-green">
                    <table border="1" style="margin: 0 auto">
                        <tr style="height: 80px;text-align: center">
                            <th style="height: 80px;text-align: center">教室号</th>
                            <th style="height: 80px;text-align: center">地点</th>
                            <th style="height: 80px;text-align: center">容量</th>
                        ...
                        <c:forEach items="${requestScope.pageCourse}" var="c">
                            <tr style="height: 80px">
                                ...
                                <td><input type="checkbox" name="selectedClassroom" class="delCourses" value="${c.id}"></td>
                            </tr>
                        </c:forEach>
                        <tr style="height: 80px">
                            <td colspan="3" align="right">
                                ...
                                第${pageCur}页&nbsp;&nbsp;
                                <c:url var="url_pre" value="courseAll">
                                    <c:param name="pageCur" value="${pageCur-1}"></c:param>
                                </c:url>
                                <c:url var="url_next" value="courseAll">
                                    <c:param name="pageCur" value="${pageCur+1}"></c:param>
                                </c:url>
                                <c:if test="${pageCur!=1}">
                            ...
                            <td colspan="1" align="center">
                                <input type="submit" value="删除教室记录">
                            </td>
                        </tr>
                    </table>
                </form>
