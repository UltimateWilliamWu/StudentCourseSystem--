        ...
        <div id="fh5co-work" class="fh5co-light-grey">
            <div class="row animate-box">
                <div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
                    ...
                    <form action="studentAdd" method="post" style="text-align: left">
                        学号:<input type="text" name="sid">
                        姓名:<input type="text" name="sname">
                        班级:<input type="text" name="sclass">
                        性别:<input type="text" name="ssex" placeholder="f/m">
                        密码:<input type="text" name="spassword">
                        专业:<input type="text" name="sdept">
                        联系方式:<input type="text" name="sphone">
                        学院:<input type="text" name="scollege">
