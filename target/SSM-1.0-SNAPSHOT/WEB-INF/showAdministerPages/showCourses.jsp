    ...
    <div class="container-wrap">
        <div id="fh5co-work" class="fh5co-light-grey">
            <div class="row animate-box">
                ...
                <form action="courseDel" method="post" class="smart-green">
                    <table border="1" style="margin: 0 auto">
                        <tr style="height: 80px;text-align: center">
                            ...
                            <th style="height: 80px;text-align: center">开课学期</th>
                        ...
                        <c:forEach items="${requestScope.pageCourse}" var="c">
                            <tr style="height: 80px">
                                ...
                                <td align="center">${c.ccourseday}</td>
                                <td align="center">${c.ccoursetime}</td>
                                <td><input type="checkbox" name="selectedCourses" class="delCourses" value="${c.cid}"></td>
                            </tr>
                        </c:forEach>
                        <tr style="height: 80px">
                            ...
                            <td colspan="1" align="center">
                                <input type="submit" value="删除课程记录">
                            </td>
                        </tr>
                    </table>
                </form>
