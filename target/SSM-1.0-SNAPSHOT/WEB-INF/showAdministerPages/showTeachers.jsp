  ...
  <div class="container-wrap">
    <div id="fh5co-work" class="fh5co-light-grey">
      <div class="row animate-box">
        ...
        <form action="teacherDel" method="post">
          <table border="1" style="margin: 0 auto">
            <tr style="height: 80px;text-align: center">
              <th style="height: 80px;text-align: center">教师号</th>
              <th style="height: 80px;text-align: center">教师名</th>
              <th style="height: 80px;text-align: center">性别</th>
              <th style="height: 80px;text-align: center">薪资</th>
              <th style="height: 80px;text-align: center">职位</th>
            ...
            <c:forEach items="${requestScope.pageTeacher}" var="t">
              <tr style="height: 80px;text-align: center">
                <td align="center">${t.tid}</td>
                <td align="center">${t.tname}</td>
                <td align="center">${t.tsex}</td>
                <td align="center">${t.tsalary}</td>
                <td align="center">${t.tposition}</td>
                <td align="center">${t.tcollege}</td>
                <td align="center">${t.tpassword}</td>
                <td><input type="checkbox" name="selectedTeachers" class="delTeachers" value="${t.tid}"></td>
              </tr>
            </c:forEach>
            <tr>
              <td colspan="7" align="right">
                ...
                第${pageCur}页&nbsp;&nbsp;
                <c:url var="url_pre" value="teacherAll">
                  <c:param name="pageCur" value="${pageCur-1}"></c:param>
                </c:url>
                <c:url var="url_next" value="teacherAll">
                  <c:param name="pageCur" value="${pageCur+1}"></c:param>
                </c:url>
                <c:if test="${pageCur!=1}">
              ...
              <td colspan="1" align="center">
                <input type="submit" value="删除老师记录">
              </td>
            </tr>
          </table>
        </form>
