        ...
        <div id="fh5co-work" class="fh5co-light-grey">
            <div class="row animate-box">
                <div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
                    ...
                    <form action="teacherAdd" method="post" style="text-align: left">
                        教师号:<input type="text" name="tid">
                        教师名:<input type="text" name="tname">
                        性别:<input type="text" name="tsex">
                        薪资:<input type="text" name="tsalary">
                        职位:<input type="text" name="tposition">
                        学院:<input type="text" name="tcollege">
                        联系方式:<input type="text" name="tphone">
