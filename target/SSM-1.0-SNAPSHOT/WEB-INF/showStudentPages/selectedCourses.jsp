                ...
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            ...
                            <li class="active"><a href="selectedCourses" >学生选课</a></li>
    ...
    <div class="container-wrap">
        <div id="fh5co-work" class="fh5co-light-grey">
            <div class="row animate-box">
                ...
                <hr>
                <p style="text-align: center">以下为所选课程信息：</p>
                <form action="delselectedCourses" class="smart-green" style="text-align: center">
                    <table border="1" style="text-align: center;margin: 0 auto;">
                        <tr style="height: 80px;text-align: center">
                            ...
                            <th style="height: 80px;text-align: center">退课</th>
                        </tr>
                        <c:forEach items="${selectedCourses}" var="Course">
                            <tr style="height: 80px">
                                ...
                                <td>${Course.tname}</td>
                                <td><label><input type="checkbox" name="deleteCourse" value="${Course.cid}">退课</label></td>
                            </tr>
                        </c:forEach>
                    </table><br><br>
