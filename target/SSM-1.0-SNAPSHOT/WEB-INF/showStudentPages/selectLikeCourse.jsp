    ...
    <div class="container-wrap">
        <div id="fh5co-work" class="fh5co-light-grey">
            <div class="row animate-box" style="text-align: center">
                ...
                <hr>
                <p style="text-align: center">请输入想要查询的课程信息：</p>
                <form action="selectCertainCourse">
                    <input type="hidden" name="studentID" value=${sessionScope.studentID}>
                    <label>
                        <input type="text" placeholder="课程名" name="cname" required="required">&nbsp;&nbsp;<input type="submit" value="查询">
                    </label>
                </form>
                <form action="selectCertainCoursesCid">
                    <input type="hidden" name="studentID" value=${sessionScope.studentID}>
                    <label>
                        <input type="text" placeholder="课程号" name="cid">&nbsp;&nbsp;<input type="submit" value="查询">
                    </label>
                </form>
                <form action="selectCertainCoursesCSemester">
                    <input type="hidden" name="studentID" value=${sessionScope.studentID}>
                    <label>
                        <input type="text" placeholder="课程学期" name="csemester">&nbsp;&nbsp;<input type="submit" value="查询">
                    </label>
                </form>
                ...
                <table border="1" class="smart-green" style="margin: 0 auto">
                    ...
                    <c:forEach items="${certainCourses}" var="Course">
